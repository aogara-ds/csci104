...
function(add_header_problem)
    ...
    # build tests
	set(MAKE_GRADE_COMMAND_BODY ${MAKE_GRADE_COMMAND_BODY} COMMAND ${CMAKE_COMMAND} -E echo "-- Compiling ${AHP_NAME} tests" CACHE "" INTERNAL FORCE)
    set(MAKE_GRADE_COMMAND_BODY ${MAKE_GRADE_COMMAND_BODY} COMMAND make ${AHP_NAME}_tests || true CACHE "" INTERNAL FORCE)
